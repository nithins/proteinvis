...
class QT_QTCOLORPICKER_EXPORT QtColorPicker : public QPushButton
{
    ...
    Q_PROPERTY(bool useStandardColors READ useStandardColorsEnabled WRITE setUseStandardColorsEnabled)
...
public:
    ...
    void setUseStandardColorsEnabled(bool enabled);
    bool useStandardColorsEnabled() const;
